...
<\/script>`,p=f.replace("</body>",`${g}</body>`);function b({className:r="",style:d}){const i=n.useRef(null),[c,v]=n.useState(()=>typeof document>"u"||!document.hidden),[h,u]=n.useState(!0),[a,o]=n.useState(!1);n.useEffect(()=>{const e=i.current;if(!e||typeof IntersectionObserver>"u")return;const s=new IntersectionObserver(([m])=>{u(m?.isIntersecting??!0)},{rootMargin:"80px"});return s.observe(e),()=>s.disconnect()},[]),n.useEffect(()=>{if(typeof document>"u")return;const e=()=>v(!document.hidden);return document.addEventListener("visibilitychange",e),()=>document.removeEventListener("visibilitychange",e)},[]);const t=h&&c;return n.useEffect(()=>{o(!1)},[t]),l.jsx("div",{ref:i,className:`web3dkit-background meridian-slow-matter${r?` ${r}`:""}`,role:"group","aria-label":"Interactive Meridian Slow Matter hero","data-state":t?a?"ready":"loading":"paused",style:{background:"#070c0e",pointerEvents:"auto",...d},children:t?l.jsx("iframe",{title:"MERIDIAN — Slow Matter",srcDoc:p,sandbox:"allow-scripts",loading:"eager",onLoad:()=>o(!0),style:{position:"absolute",inset:0,display:"block",width:"100%",height:"100%",border:0,background:"#070c0e",opacity:a?1:0,pointerEvents:a?"auto":"none",transition:"opacity 240ms ease-out"}}):null})}export{b as MeridianSlowMatter};
