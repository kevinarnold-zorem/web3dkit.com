import{r as a,j as o}from"./index-ChUl42DD.js";const s=`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
...
`,l=`<style id="web3dkit-sketchbook-host">
...
</style>`;function p(n="/sketchbook/"){const e=n.endsWith("/")?n:`${n}/`;return s.replaceAll("sketchbook/",e).replace("</head>",`${l}</head>`)}function d({assetBaseUrl:n="/sketchbook/",className:e=""}){const[t,r]=a.useState(!1),i=a.useMemo(()=>p(n),[n]);return o.jsx("div",{className:`sketchbook${e?` ${e}`:""}`,"data-state":t?"ready":"loading",children:o.jsx("iframe",{className:`sketchbook__frame${t?" is-ready":""}`,title:"Interactive Singapore sketchbook",srcDoc:i,sandbox:"allow-scripts",loading:"eager",onLoad:()=>r(!0)})})}export{d as Sketchbook};
