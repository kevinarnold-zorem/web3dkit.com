import{r as n,j as l}from"./index-fOQwe-l-.js";const g=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
<\/script>`,v=g.replace("</body>",`${m}</body>`);function x({className:o="",style:c}){const r=n.useRef(null),[d,h]=n.useState(()=>typeof document>"u"||!document.hidden),[u,p]=n.useState(!0),[t,i]=n.useState(!1);n.useEffect(()=>{const e=r.current;if(!e||typeof IntersectionObserver>"u")return;const s=new IntersectionObserver(([f])=>{p(f?.isIntersecting??!0)},{rootMargin:"80px"});return s.observe(e),()=>s.disconnect()},[]),n.useEffect(()=>{if(typeof document>"u")return;const e=()=>h(!document.hidden);return document.addEventListener("visibilitychange",e),()=>document.removeEventListener("visibilitychange",e)},[]);const a=u&&d;return n.useEffect(()=>{i(!1)},[a]),l.jsx("div",{ref:r,className:`web3dkit-background foldwork-hero${o?` ${o}`:""}`,role:"group","aria-label":"Interactive Foldwork product studio hero","data-state":a?t?"ready":"loading":"paused",style:{background:"#111111",pointerEvents:"auto",...c},children:a?l.jsx("iframe",{title:"Foldwork — Products built to outlast the hype that sold them",srcDoc:v,sandbox:"allow-scripts",loading:"eager",onLoad:()=>i(!0),style:{position:"absolute",inset:0,display:"block",width:"100%",height:"100%",border:0,background:"#111111",opacity:t?1:0,pointerEvents:t?"auto":"none",transition:"opacity 240ms ease-out"}}):null})}export{x as FoldworkHero};
