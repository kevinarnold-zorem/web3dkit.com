import{r as n,j as l}from"./index-fOQwe-l-.js";const v=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8">
...
`;function g({className:o="",style:c}){const r=n.useRef(null),[d,u]=n.useState(()=>typeof document>"u"||!document.hidden),[h,p]=n.useState(!0),[t,i]=n.useState(!1);n.useEffect(()=>{const e=r.current;if(!e||typeof IntersectionObserver>"u")return;const s=new IntersectionObserver(([f])=>{p(f?.isIntersecting??!0)},{rootMargin:"80px"});return s.observe(e),()=>s.disconnect()},[]),n.useEffect(()=>{if(typeof document>"u")return;const e=()=>u(!document.hidden);return document.addEventListener("visibilitychange",e),()=>document.removeEventListener("visibilitychange",e)},[]);const a=h&&d;return n.useEffect(()=>{i(!1)},[a]),l.jsx("div",{ref:r,className:`web3dkit-background flower-field${o?` ${o}`:""}`,role:"group","aria-label":"Interactive procedural flower valley","data-state":a?t?"ready":"loading":"paused",style:{background:"#3a3268",pointerEvents:"auto",...c},children:a?l.jsx("iframe",{title:"Flower Field",srcDoc:v,sandbox:"allow-scripts",loading:"eager",onLoad:()=>i(!0),style:{position:"absolute",inset:0,display:"block",width:"100%",height:"100%",border:0,background:"#3a3268",opacity:t?1:0,pointerEvents:t?"auto":"none",transition:"opacity 240ms ease-out"}}):null})}export{g as FlowerField};
