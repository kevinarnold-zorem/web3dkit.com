import{r as n,j as i}from"./index-ChUl42DD.js";import{L as c}from"./LandingPages-Bks_nP6T.js";import"./SylvaLivingWorldScene-D5ro5Tc6.js";const o="threeui-orrery-presentation";function p(r){const t=r.contentDocument;if(!t)return;t.querySelectorAll(".tp, .tp-btn").forEach(e=>e.remove());let a=t.getElementById(o);a||(a=t.createElement("style"),a.id=o,t.head.appendChild(a)),a.textContent=`
