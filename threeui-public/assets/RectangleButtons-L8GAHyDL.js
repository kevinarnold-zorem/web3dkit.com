const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LumenCta-BsTS3omf.js","assets/index-fOQwe-l-.js","assets/index-x9bNS8sK.css","assets/LumenCta-DrIkYxHz.css","assets/NeuformIsolatedEffects-BusBxLeb.js"])))=>i.map(i=>d[i]);
import{j as e,r as a,_ as r}from"./index-fOQwe-l-.js";import{DarkGlassButton as d}from"./SectionElements-CT23Jvmk.js";const b=a.lazy(()=>r(()=>import("./LumenCta-BsTS3omf.js"),__vite__mapDeps([0,1,2,3])).then(t=>({default:t.LumenCta}))),p={"launch-button":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.LaunchButton}))),"dot-border-button":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.DotBorderButton}))),"floating-dots-cta":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.FloatingDotsCta}))),"sliding-text-cta":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.SlidingTextCta}))),"gradient-beam-cta":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.GradientBeamCta}))),"gradient-pill-button":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.GradientPillButton}))),"generate-button":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.GenerateButton}))),"glassmorphism-cta":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.GlassmorphismCta}))),"spinning-border-button":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.SpinningBorderButton}))),"gradient-cta":a.lazy(()=>r(()=>import("./NeuformIsolatedEffects-BusBxLeb.js"),__vite__mapDeps([4,1,2])).then(t=>({default:t.GradientCta})))},h=new Set(["trochil-signal","attune-thermal","tideform-outline","understory-arrow-pill","meridian-keycap-primary","meridian-keycap-secondary","halvorsen-arrow-pill","aster-glass-access","aster-glass-arrow"]);function l(t){return h.has(t)}const c=`
...
`;function u({long:t=!1}){return t?e.jsx("svg",{viewBox:"0 0 21 9","aria-hidden":"true",children:e.jsx("path",{d:"M0 4.5h18M14.5 1.2 18.3 4.5l-3.8 3.3"})}):e.jsx("svg",{viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M3 1.5 8 6 3 10.5"})})}function x({variant:t,mode:o="dark",className:s="",style:g}){let i="trochil",n=null;switch(t){case"trochil-signal":n=e.jsx("button",{className:"threeui-page-button threeui-page-button--trochil",type:"button",children:e.jsx("span",{children:"Request access"})});break;case"attune-thermal":i="attune",n=e.jsxs("button",{className:"threeui-page-button threeui-page-button--attune",type:"button",children:[e.jsx("span",{children:"Start free"}),e.jsx(u,{})]});break;case"tideform-outline":i="tideform",n=e.jsxs("button",{className:"threeui-page-button threeui-page-button--tideform",type:"button",children:[e.jsx("span",{children:"See the work"}),e.jsx(u,{long:!0})]});break;case"understory-arrow-pill":i="understory",n=e.jsxs("button",{className:"threeui-page-button threeui-page-button--arrow-pill threeui-page-button--understory",type:"button",children:[e.jsx("span",{children:"Begin"}),e.jsx("span",{className:"threeui-page-button__disc",children:e.jsx(u,{})})]});break;case"meridian-keycap-primary":i="meridian",n=e.jsxs("button",{className:"threeui-page-button threeui-page-button--meridian threeui-page-button--meridian-primary",type:"button",children:[e.jsx("span",{className:"threeui-page-button__led"}),e.jsx("span",{children:"Start free"})]});break;case"meridian-keycap-secondary":i="meridian",n=e.jsxs("button",{className:"threeui-page-button threeui-page-button--meridian",type:"button",children:[e.jsx("span",{className:"threeui-page-button__led"}),e.jsx("span",{children:"Book a walkthrough"})]});break;case"halvorsen-arrow-pill":i="halvorsen",n=e.jsxs("button",{className:"threeui-page-button threeui-page-button--arrow-pill threeui-page-button--halvorsen",type:"button",children:[e.jsx("span",{children:"See the work"}),e.jsx("span",{className:"threeui-page-button__disc",children:e.jsx(u,{})})]});break;case"aster-glass-access":i="aster",n=e.jsx("button",{className:"threeui-page-button threeui-page-button--aster threeui-page-button--aster-access",type:"button",children:e.jsx("span",{children:"Get access"})});break;case"aster-glass-arrow":i="aster",n=e.jsxs("button",{className:"threeui-page-button threeui-page-button--aster threeui-page-button--aster-arrow",type:"button",children:[e.jsx("span",{children:"Start free"}),e.jsx("span",{className:"threeui-page-button__chip",children:e.jsx("svg",{viewBox:"0 0 12 12","aria-hidden":"true",children:e.jsx("path",{d:"M2 6h8M6.6 2.6 10 6 6.6 9.4"})})})]});break}return e.jsxs("div",{className:`threeui-page-button-stage threeui-page-button-stage--${i}${s?` ${s}`:""}`,"data-mode":o,"data-variant":t,style:g,children:[e.jsx("style",{children:c}),n]})}function m({variant:t="dark-pill",...o}){if(t==="dark-pill")return e.jsx(d,{className:o.className,style:o.style,mode:o.mode==="light"?"light":"dark"});if(t==="lumen-cta"||t==="lumen-cta-ghost")return e.jsx(a.Suspense,{fallback:null,children:e.jsx(b,{...o,variant:t==="lumen-cta-ghost"?"ghost":"primary"})});if(l(t))return e.jsx(x,{variant:t,mode:o.mode,className:o.className,style:o.style});const s=p[t];return e.jsx(a.Suspense,{fallback:null,children:e.jsx(s,{...o})})}const w=m;export{w as DarkGlassButton,m as RectangleButtons};
