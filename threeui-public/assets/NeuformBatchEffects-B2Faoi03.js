...
${e.focusCss??""}
</style>`,x=`<script data-threeui-controls>
(function () {
  var controls = ${i};
...
<\/script>`,f=`<script data-threeui-focus>
(function () {
  var isolated = false;
  function isolate() {
    if (isolated) return;
